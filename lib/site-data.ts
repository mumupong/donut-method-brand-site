...
export const founderStory = {
  ...
  paragraphs: [
    "私は長い間、『次へ行けば満たされる』と思っていました。CAになれば、フリーランスになれば、Dellに入れば、海外に移住すれば。そうやって環境や肩書きを変え続けても、心の中の『まだ足りない』は消えませんでした。",
    "転機は、マレーシアのモールで、1歳の娘がショーケースのドーナツを見て『ドードー！』と指差した瞬間でした。娘はまだ本物のドーナツをよく知らないのに、穴のあるその形を見て『ドーナツ』だと認識したのです。",
    "その時、私は気づきました。『そうか、穴があるからドーナツなんだ』と。穴は、埋めなければならない欠陥ではなく、成立の一部だった。私も同じでした。足りない部分を埋め続けることより、すでにある生地を見ることが必要だったのです。"
  ]
};
...
export const missionStatement = {
  title: "このメソッドを届けたい理由",
  paragraphs: [
    "このメソッドを残したいのは、私自身のためだけではありません。我が子と、その先の世代が、達成や比較だけを幸せの尺度にせず、自分の生地を見失わずに生きられるようにするためです。",
    "目的地に着くことだけを急がず、そこへ向かう道のりの中にある景色や感情や関係を味わいながら、自分の味で人生を進めるための地図として、ドーナツメソッドを届けたいと思っています。"
  ]
};
